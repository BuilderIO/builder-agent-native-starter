 ...
 *
 * Read with `drizzle/schema.ts`. Do not move this file into `actions/` as-is;
 * copy the pieces you need into `actions/<name>.ts` after the matching table
 * exists in the schema and has been migrated (`pnpm db:generate` +
 * `pnpm db:migrate`).
 *
