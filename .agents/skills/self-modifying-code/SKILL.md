...
| ------------- | ----------- |
| UI / copy / layout only | Formatter if the app has one; preview or `DevServerLogs` if something looks wrong. Skip full typecheck unless the edit touched types or imports. |
